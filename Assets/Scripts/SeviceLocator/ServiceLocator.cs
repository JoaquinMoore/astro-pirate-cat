...
namespace UnityServiceLocator
{
    ...
    public class ServiceLocator : MonoBehaviour
    {
        ...
        private void OnDestroy()
        {
            if (this == global)
                global = null;
            else if (sceneContainers.ContainsValue(this)) sceneContainers.Remove(gameObject.scene);
        }
        ...
        public static ServiceLocator ForSceneOf(MonoBehaviour mb)
        {
            ...
            foreach (var go in tmpSceneGameObjects.Where(go => go.GetComponent<ServiceLocatorScene>() != null))
                if (go.TryGetComponent(out ServiceLocatorScene bootstrapper) && bootstrapper != mb)
                {
